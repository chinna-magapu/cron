...
$outfile = "D:\HostingSpaces\admin\bioappeng.us\data\WS\processed\archive\SAR_2018.all.txt"
 
#----- get files based on lastwrite filter and specified folder ---#
$Files = Get-Childitem $TargetFolder -Include SARATOGA*_WS.dat | Where {$_.LastWriteTime -le "$LastWrite"}
